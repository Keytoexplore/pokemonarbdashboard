  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {cards.map((card) => {
        ...
        return (
          <div key={card.id} className="bg-gray-900 rounded-xl p-6 border border-gray-800 hover:border-blue-500/50 transition">
            ...
            <div className="space-y-2">
              {japanToreca && (
                ...
                >
                  ...
                  {japanToreca.quality && (
                    <span className="text-xs text-gray-400">Quality: {japanToreca.quality}</span>
                  )}
                </a>
              )}
              ...
              {torecaCamp && (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block bg-purple-900/30 hover:bg-purple-900/50 border border-purple-700/50 rounded-lg px-4 py-3 transition"
                >
                  <div className="flex justify-between items-center">
                    <span className="text-purple-400 text-sm">TorecaCamp</span>
                    <span className="font-bold">¥{torecaCamp.priceJPY.toLocaleString()}</span>
                  </div>
                </a>
              )}
            </div>
